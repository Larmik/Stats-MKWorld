...
@TypeConverters(value = [WarTrackConverter::class, WarPositionConverter::class, WarPenaltyConverter::class, StringConverter::class])
@Database(entities = [WarEntity::class, PlayerEntity::class, TeamEntity::class], version = 4)
