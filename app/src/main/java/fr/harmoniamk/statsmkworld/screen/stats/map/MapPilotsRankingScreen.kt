 ...
 * mutualisée (rule 16), texte blanc sur le fond du BaseScreen.
 */
...
fun MapPilotsRankingScreen(
    ...
    BaseScreen(title = stringResource(R.string.map_detail_pilots), modifier = Modifier.padding(bottom = 90.dp)) {
        when {
