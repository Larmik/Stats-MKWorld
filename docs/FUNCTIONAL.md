...
- **Contribution** (Individuelles) : **deux lignes** (#69) — (1) **% des points** de l'équipe (moyenne war par war) + rang de contributeur ; (2) **% de shocks** de l'équipe (**total shocks joueur ÷ total shocks équipe**, ratio de totaux, **pas une moyenne**) + rang de baggeur, sur le classement des baggeurs de la même fenêtre. La 2ᵉ ligne est masquée si l'équipe n'a obtenu aucun shock sur la période.
