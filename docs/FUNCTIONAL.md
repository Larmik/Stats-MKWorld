...
| **Shocks/war** | Nombre moyen d'objets éclair pris par war (les tiens en Indiv). | Suivre l'exposition aux éclairs — indicateur de jeu, pas de score. | Une moyenne (« 1,5 »). | Neutre : ni haut ni bas n'est « bon » dans l'absolu. | Corréler avec des contre-performances. | Le shock est un objet (item), hors calcul du score ; son delta s'affiche sans couleur. |
...
| **Shocks joués / par war (face à eux)** | Nombre d'éclairs pris contre cet adversaire (total et moyenne par war). | Contexte de jeu face à eux. | Un total + une moyenne. | Neutre (indicateur de jeu, pas de score). | Corréler avec des contre-performances face à eux. | Hors calcul du score. |
...
| **Shocks joués** | Nombre d'éclairs pris sur ce circuit. | Contexte de jeu du circuit. | Un compte. | Neutre. | Repérer un circuit « à éclairs ». | Suit le sélecteur Indiv/Équipe ; hors score. |
