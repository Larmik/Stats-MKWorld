...
Les **tuiles adversaires** affichent le **logo de l'équipe** et les **tuiles circuits** l'**illustration du circuit** (vignette). En complément des sections maquette, l'écran conserve **toutes** les sections détaillées de l'ancien écran de stats (rien n'est perdu), sous forme de sections dépliables : **Forme récente** (comparaison all-time / 5 / 10 dernières wars), **Records & séries** (série en cours, records V/D, Top6/Bot6), **Indicateurs avancés** (régularité, amplitude, marges de victoire/défaite, contribution, 1ʳᵉ/2ᵉ moitié, invaincu depuis, points perdus en pénalités), **Meilleurs/pires circuits** (top3/flop3 par winrate ET score) et **Meilleurs/pires adversaires** (top3/flop3 par winrate ET score, avec logos/illustrations dans les cellules réutilisées).
